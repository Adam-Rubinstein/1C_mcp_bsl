...
group = "io.github.adamrubinstein"
...
tasks.bootJar {
    ...
    archiveFileName.set("1C_mcp_bsl.jar")
    mainClass.set("io.github.adamrubinstein.mcpbsl.McpServerApplicationKt")
}
...
publishing {
    repositories {
        maven {
            name = "1C_mcp_bsl"
            url = uri("https://maven.pkg.github.com/Adam-Rubinstein/1C_mcp_bsl")
            credentials {
